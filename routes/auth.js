...
const { requestOtp, verifyOtp, register, login, sendResetPasswordOtp, sendResetPasswordOtpEmployee, resetPassword, loginEmployee, registerEmployee } = require('../controllers/auth')
